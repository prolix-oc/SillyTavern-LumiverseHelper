...
const DOMUtils = {
  ...
  getDistanceBetween(element1, element2) {
    const elem1 =
      typeof element1 === "string" ? this.query(element1) : element1;
    const elem2 =
      typeof element2 === "string" ? this.query(element2) : element2;
  ...
  logElementMeasurements(target, label = "Element") {
    const element =
      typeof target === "string" ? DOMUtils.query(target) : target;
