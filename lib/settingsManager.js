...
export function migrateSettings() {
    ...
    if ((settings.lumiaLibrary || settings.worldBookData) && Object.keys(settings.packs).length === 0) {
        ...
        if (items.length === 0 && settings.worldBookData) {
            ...
            console.warn("Legacy worldBookData found but cannot be migrated automatically. Please re-import your world book.");
        }
    ...
    if (settings.dominantPersonality === undefined) settings.dominantPersonality = null;
