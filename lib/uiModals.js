...
export function showSummarizationModal() {
            ...
            <div class="lumia-modal-content">
                ...
                <div class="lumia-modal-panel">
                    ...
                    <div class="lumia-modal-panel-content">
                        ...
                        <div class="lumia-trunc-options ${truncEnabled ? "" : "lumia-trunc-options-hidden"}">
                            <div class="lumia-modal-field">
                                <label class="lumia-modal-label" for="lumia-trunc-count-input">Messages to keep</label>
                                <input type="number" id="lumia-trunc-count-input" class="lumia-modal-input" min="5" max="500" value="${truncKeepCount}" />
                                <span class="lumia-modal-hint">Number of recent messages to include in context</span>
                            </div>
  ...
  $modal.find("#lumia-sum-provider-select").change(function () {
    ...
    $modal
      .find("#lumia-sum-endpoint-input")
      .attr("placeholder", defaults.endpoint);
  });

  // Handle message truncation toggle
  $modal.find("#lumia-trunc-toggle").change(function () {
    const $options = $modal.find(".lumia-trunc-options");
    if ($(this).is(":checked")) {
      $options.removeClass("lumia-trunc-options-hidden");
    } else {
      $options.addClass("lumia-trunc-options-hidden");
    }
  });
  ...
  $modal.find("#lumia-sum-test-btn").click(async function () {
    ...
    $status.html(
      '<span class="lumia-modal-status-loading">Generating summary...</span>',
    );
    ...
    try {
      ...
      if (result) {
        $status.html(
          `<span style="color: #4CAF50;">Summary generated successfully!</span><br><small>Check your chat metadata.</small>`,
        );
        toastr.success("Summary generated and saved to chat metadata!");
      } else {
        $status.html(
          `<span style="color: #f44336;">No summary generated. Check console for details.</span>`,
        );
      }
    } catch (error) {
                            ...
                            <div class="lumia-filter-item">
                                <div class="lumia-toggle-row">
                                    <label class="lumia-toggle-label" for="lumia-filter-html-toggle">
                                        ...
                                        <span class="lumia-toggle-hint">Removes common formatting tags: &lt;font&gt;, &lt;div&gt;, &lt;span&gt;, &lt;b&gt;, &lt;i&gt;, &lt;u&gt;, &lt;em&gt;, &lt;strong&gt;</span>
                                    </label>
                                    <div class="lumia-toggle-switch-wrapper">
