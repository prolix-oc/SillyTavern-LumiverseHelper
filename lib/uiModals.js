...
export function showSelectionModal(type) {
    ...
    if (packs.length === 0) {
        ...
        packs.forEach(pack => {
            ...
            <div class="lumia-modal-panel">
                ...
                <div class="lumia-modal-panel-content lumia-modal-panel-content-cards">
    ...
    const modalHtml = `
        <div class="lumia-modal-backdrop" id="lumia-selection-backdrop"></div>
        <dialog id="lumia-selection-modal" class="lumia-modal lumia-modal-selection">
    ...
    const $backdrop = $("#lumia-selection-backdrop");
    ...
    // Stop propagation on backdrop and modal to prevent ST from closing the drawer
    $backdrop.on("click mousedown mouseup", function(e) {
        e.stopPropagation();
        // Only close on click, not mousedown/mouseup
        if (e.type === "click") closeModal();
    });

    // Stop all click events from bubbling out of the modal
...
export function showMiscFeaturesModal() {
    ...
    const modalHtml = `
        <div class="lumia-modal-backdrop" id="lumia-misc-backdrop"></div>
        <dialog id="lumia-misc-modal" class="lumia-modal lumia-modal-settings">
            <div class="lumia-modal-header">
                <div class="lumia-modal-header-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    const $backdrop = $("#lumia-misc-backdrop");
...
export function showLoomSelectionModal(category) {
        ...
        packs.forEach(pack => {
            ...
            if (itemsHtml) {
                ...
                <div class="lumia-modal-panel">
                    ...
                    <div class="lumia-modal-panel-content lumia-modal-panel-content-list">
    ...
    const modalHtml = `
        <div class="lumia-modal-backdrop" id="loom-selection-backdrop"></div>
        <dialog id="loom-selection-modal" class="lumia-modal lumia-modal-selection">
            <div class="lumia-modal-header">
                <div class="lumia-modal-header-icon">
                    ${headerIcon}
                </div>
    ...
    const $backdrop = $("#loom-selection-backdrop");
...
export function showSummarizationModal() {
    ...
    const modalHtml = `
        <div class="lumia-modal-backdrop" id="lumia-summarization-backdrop"></div>
        <dialog id="lumia-summarization-modal" class="lumia-modal lumia-modal-settings">
            <div class="lumia-modal-header">
                <div class="lumia-modal-header-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    const $backdrop = $("#lumia-summarization-backdrop");
